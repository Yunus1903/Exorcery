...
public class MagicalPotionItem extends ExorceryItem
{
    ...
    {
        tooltip.add(new TranslationTextComponent("item.exorcery.magical_potion.tooltip.line1").mergeStyle(TextFormatting.GRAY));
        tooltip.add(new TranslationTextComponent("item.exorcery.magical_potion.tooltip.line2").mergeStyle(TextFormatting.GRAY));
    }
